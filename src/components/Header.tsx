...
const Header = () => {
  ...
  return (
    <header className="z-[999] relative">
      <div className="hidden fixed top-[0.5rem] bottom-[1rem] right-[1rem] md:top-[2rem] sm:right-[2rem] z-5000">
        <DropdownMenu>
          <DropdownMenuTrigger asChild>
            <Button variant="outline" size="icon">
              <SunIcon className="h-[1.2rem] w-[1.2rem] rotate-0 scale-100 transition-all dark:-rotate-90 dark:scale-0 focus:outline-none" />
